...
<head>
    ...
    <title>Staff Create New Password — Education Management System</title>
...
<div class="page">
    <div class="left">
        ...
        <div class="left-content">
            ...
            <p>Please enter a strong new password containing at least 6 characters to reset your password and login to your staff portal.</p>
        </div>
    </div>
    <div class="right">
        <div class="form-card">
            ...
            <form id="staffCreatePasswordForm">
                @csrf
...
<script>
    ...
    document.getElementById('staffCreatePasswordForm').addEventListener('submit', function(e) {
        e.preventDefault();

...
<script>
    ...
    <title>Staff Portal - Education Management System</title>
...
<aside id="layout-menu" class="layout-menu menu-vertical menu">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item @if(Route::is('staffprofile')) active @endif">
            <a href="{{ route('staffprofile') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-user"></i>
                <div>My Profile</div>
            </a>
        </li>
        <li class="menu-item @if(Route::is('staffstudentmanagement')||Route::is('staffcreatestudent')||Route::is('staffeditstudent')) active @endif">
            <a href="{{ route('staffstudentmanagement') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-users"></i>
                <div>Students</div>
            </a>
        </li>
        <li class="menu-item @if(Route::is('staffstudentattendance')) active @endif">
            <a href="{{ route('staffstudentattendance') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-calendar-check"></i>
                <div>Student Attendance</div>
            </a>
        </li>
        <li class="menu-item @if(Route::is('staffleaverequests')) active @endif">
            <a href="{{ route('staffleaverequests') }}" class="menu-link">
                <i class="menu-icon icon-base ti tabler-calendar-off"></i>
                <div>My Leave Requests</div>
            </a>
        </li>
        <li class="menu-item mt-3">
            <a class="menu-link" data-bs-toggle="modal" data-bs-target="#staffLogoutModal" style="cursor:pointer;">
...
<div class="layout-page">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                <li class="nav-item dropdown me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><button type="button" class="dropdown-item" data-bs-theme-value="light"><i class="icon-base ti tabler-sun icon-22px me-3"></i>Light</button></li>
                        <li><button type="button" class="dropdown-item" data-bs-theme-value="dark"><i class="icon-base ti tabler-moon icon-22px me-3"></i>Dark</button></li>
                        <li><button type="button" class="dropdown-item" data-bs-theme-value="system"><i class="icon-base ti tabler-device-desktop icon-22px me-3"></i>System</button></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="content-wrapper">
        ...
        <div class="modal fade" id="staffLogoutModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content text-center p-4" style="border-radius:14px;border:none;">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <form action="{{ route('stafflogout') }}" method="POST" class="m-0">
                            @csrf

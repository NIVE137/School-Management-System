...
<head>
    ...
    <title>Staff Sign In — Education Management System</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .left .c3 { width:160px;height:160px;top:38%;right:80px;animation-delay:7s;background:rgba(99,102,241,0.08); }
        ...
        .feat i { color: #93c5fd; font-size: 0.82rem; }
        ...
        .right::before {
            ...
            width: 300px; height: 300px; border-radius: 50%; background: rgba(99,102,241,0.04);
        }
        .right::after {
            content: ''; position: absolute; bottom: -100px; left: -60px;
            width: 280px; height: 280px; border-radius: 50%; background: rgba(14,165,233,0.04);
        }
        ...
        .portal-badge {
            ...
            color: #4f46e5; margin-bottom: 22px; letter-spacing: 0.3px;
        }
        ...
        .iw input:focus { outline: none; border-color: #6366f1; box-shadow: 0 0 0 3px rgba(99,102,241,0.13); }
        ...
        .remember-wrap input { accent-color: #6366f1; cursor: pointer; }
        ...
        .btn-sign:hover {
            ...
            box-shadow: 0 8px 28px rgba(99,102,241,0.42); transform: translateY(-1px);
        }
        ...
        .pl:hover { border-color: #6366f1; color: #6366f1; background: rgba(99,102,241,0.04); }
...
<div class="page">
    ...
    <div class="left">
        ...
        <div class="content">
            ...
            <h1>Staff Management<br><span>Portal</span></h1>
            <p class="sub">Access student attendance, submit leave applications, manage classes, and track your teaching workflow.</p>

            <div class="stats-row">
                <div class="stat-box">
                    <i class="fas fa-chalkboard-teacher" style="color:#60a5fa;"></i>
                    <div class="num">Staff</div>
                    <div class="lbl">Dashboard</div>
                </div>
                <div class="stat-box">
                    <i class="fas fa-calendar-check" style="color:#34d399;"></i>
                    <div class="num">Attendance</div>
                    <div class="lbl">Tracker</div>
                </div>
                <div class="stat-box">
                    <i class="fas fa-calendar-minus" style="color:#f59e0b;"></i>
                    <div class="num">Leaves</div>
                    <div class="lbl">Portal</div>
                </div>
            </div>

            <div class="feat-row">
                <div class="feat"><i class="fas fa-user-graduate"></i> Student Records</div>
                <div class="feat"><i class="fas fa-calendar-alt"></i> Daily Attendance</div>
                <div class="feat"><i class="fas fa-folder-open"></i> Document Portal</div>
                <div class="feat"><i class="fas fa-shield-alt"></i> Secure Access</div>
            </div>
        </div>
    ...
    <div class="right">
        <div class="form-wrap">
            ...
            <p class="form-sub">Sign in to access your staff portal and manage your classes.</p>
            ...
            <form id="staffLoginForm">
                ...
                <div class="fg">
                    ...
                    <div class="iw">
                        ...
                        <input type="email" id="email" name="email" placeholder="staff@school.com" autocomplete="email">
                    </div>
                </div>
                <div class="fg">
                ...
                <div class="row-middle">
                    ...
                    <a href="{{ route('staffforgetpassword') }}" class="forgot-link"><i class="fas fa-key me-1"></i>Forgot Password?</a>
                </div>
            ...
            <div class="portal-links">
                ...
                <a href="{{ route('studentlogin') }}" class="pl">

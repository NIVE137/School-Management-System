...
.doc-label{font-size:0.78rem;font-weight:600;color:#566a7f;margin-bottom:8px;}
...
<div class="custom-card">
    <form action="{{ route('staffsavedocuments', $student->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
...
function previewFile(input,field){
    ...
    if(file.type.startsWith('image/')){const r=new FileReader();r.onload=function(e){img.src=e.target.result;img.style.display='block';pdf.style.display='none';};r.readAsDataURL(file);}

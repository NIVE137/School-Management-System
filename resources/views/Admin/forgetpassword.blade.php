...
<head>
    ...
    <title>Admin Forgot Password — Education Management System</title>
...
<div class="page">
    <div class="left">
        ...
        <div class="left-content">
            ...
            <p>Don't worry! Enter your registered administrator email address and we will verify your account to reset your password.</p>
        </div>
    </div>
    <div class="right">
        <div class="form-card">
            ...
            <p>Enter your administrator email address below.</p>
            <form id="forgetPasswordForm">
                @csrf
                <div class="form-group">
                    <label for="fp_email">Email Address</label>
                    <div class="input-box">
                        <input type="email" id="fp_email" name="email" placeholder="admin@school.com" required>
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.status === "success") {
                    ...
                    toastr.error(res.message || "Email not found.");
                    btn.disabled = false;

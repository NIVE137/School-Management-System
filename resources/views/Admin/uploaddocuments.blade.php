            ...
            <div class="col-md-4">
                ...
                <div class="image-upload">
                    ...
                    <div class="mt-3 d-flex gap-2 flex-wrap justify-content-center">
                        ...
                        @if($student->$field)
                            <a href="{{ route('deletedocument', [$student->id, $field]) }}" class="btn btn-danger btn-sm" style="font-size:0.76rem;" onclick="return confirm('Are you sure you want to delete this document?')"><i class="fas fa-trash me-1"></i>Delete</a>
                        @endif
                    </div>
                </div>
            </div>

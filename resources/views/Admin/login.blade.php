...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── LEFT — school photo background with overlay ── */
        .left {
            flex: 0 0 58%;
            position: relative;
            overflow: hidden;
        ...
        /* School logo — original eeschool.png, displayed large */
        .left .school-logo {
        ...
        .left .school-logo img {
            height: 60px;
            width: auto;
            mix-blend-mode: screen; /* removes the black background from the PNG */
        }
        ...
        /* School illustration image strip */
        .illus-strip {
        ...
        .illus-strip img {
            height: 90px; width: 90px; border-radius: 12px;
        ...
        .portal-badge {
            ...
            color: #4f46e5; margin-bottom: 22px;
            letter-spacing: 0.3px;
        }
        .portal-badge i { font-size: 0.8rem; }
...
<div class="page">
    ...
    <div class="left">
        ...
        <div class="content">
            ...
            <div class="stats-row">
                ...
                <div class="stat-box">
                    <i class="fas fa-user-graduate" style="color:#34d399;"></i>
            ...
            <div class="feat-row">
                <div class="feat"><i class="fas fa-calendar-check"></i> Attendance</div>
                <div class="feat"><i class="fas fa-money-bill-wave"></i> Fee Management</div>
                <div class="feat"><i class="fas fa-book-open"></i> Classes</div>
                <div class="feat"><i class="fas fa-shield-halved"></i> Role Control</div>
                <div class="feat"><i class="fas fa-chart-line"></i> Reports</div>
            </div>
        </div>

        <!-- Bottom image strip using existing school photos -->
    ...
    <div class="right">
        <div class="form-wrap">
            ...
            <p class="form-sub">Sign in to access your admin dashboard and manage the school system.</p>
            ...
            <form id="loginForm">
                ...
                <div class="fg">
                    ...
                    <div class="iw">
                        ...
                        <input type="email" id="email" name="email" placeholder="admin@school.com" autocomplete="email">
                    </div>
                </div>
                <div class="fg">
                ...
                <div class="row-middle">
                    <span></span>
                    <a href="{{ route('forgetpassword') }}" class="forgot-link"><i class="fas fa-key me-1"></i>Forgot Password?</a>
                </div>
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status === 'success') {
                    ...
                    btn.prop('disabled', false).html('<i class="fas fa-sign-in-alt me-2"></i>Sign In to Dashboard');
                }
            },
            error: function (xhr) {

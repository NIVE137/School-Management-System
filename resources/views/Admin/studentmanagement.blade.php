...
<div class="page-header">
    <div>
        ...
        <small class="text-muted">Manage enrolled students, classes and documents</small>
    </div>
    <div class="d-flex gap-2 flex-wrap">
        <button class="btn-cyan" onclick="location.href='{{ route('createclass') }}'"><i class="fa-solid fa-plus"></i> Create Class</button>
        <button class="btn-cyan" onclick="location.href='{{ route('createstudent') }}'"><i class="fa-solid fa-user-plus"></i> Add Student</button>
    </div>
</div>

<div class="custom-card">
    <div class="table-responsive">
        <table class="table table-custom table-borderless align-middle w-100" id="student-table">
            <thead>
                <tr>
...
function deleteStudent(id) {
    Swal.fire({
        ...
        if (r.isConfirmed) {
            $.ajax({
                url: '/Admin/deletestudent/' + id, type: 'DELETE',
